...
namespace IndexTest
{
    ...
    class BTree<T>
    {
        ...
        public BTree(CompareT _compare, GetDefault _getDefault)
        {
        ...
        public IntPtr Search(BTreeNode<T> b, T key)
        {
            int pos;
            IntPtr result;
        ...
        public void Insert(ref BTreeNode<T> b, T key, IntPtr value)
        {
        ...
        int SearchKeyInNode(List<T> keys, T key)
        {
            int lo = -1;
            int hi = keys.Count;
            int mid = -1;
        ...
        BTreeNode<T> BTInsertInternal(BTreeNode<T> b, T key, IntPtr value, ref T medianKey, ref IntPtr medianValue)
        {
            int pos;    //insert pos
            int mid;    //splite pos
